...
import 'package:airbnb_clone/WishListPage.dart';
...
class _LandingPageScreenState extends State<LandingPageScreen> {
  ...
  @override
  void initState() {
    listOfSortedPlaces = SearchingClass().Search(CardDesign.PlaceDetails, '');
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Row(
                                        children: [
                                          Expanded(flex: (ScreenWidth>650)  ? 2 : 1, child: Container()),
                                          Expanded(
                                            flex: (ScreenWidth>650) ? 8 : 4,
                                            child: Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    width:  (ScreenWidth>650) ?10 : 5,
                                                  ),
                                                  Expanded(
                                                    flex:  (ScreenWidth>650) ? 8 : 6 ,
                                                    child: Center(
                                                      child: TextFormField(
                                                        style: TextStyle(
                                                            color: Colors
                                                                .grey[700],
                                                            fontSize: (ScreenWidth>650) ? 17 : 13),
                                                        maxLines: 1,
                                                        decoration:
                                                            InputDecoration(
                                                          hintText:
                                                          ...
                                                          Text(
                                                            ...
                                                            style: TextStyle(
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w500,
                                                                fontSize:  (ScreenWidth>660) ? 18 :12,
                                                                fontFamily:
                                                                    'Axiforma'),
                                                          ),
                                                        ],
                                                          ...
                                                          Text(
                                                            ...
                                                            style: TextStyle(
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w500,
                                                                fontSize: (ScreenWidth>650) ?18 : 14,
                                                                fontFamily:
                                                                    'Axiforma'),
                                                          ),
                                                          // SizedBox(width: 20,)
                                                        ...
                                                        child: Padding(
                                                          padding:
                                                              const EdgeInsets
                                                                  .all(8.0),
                                                          child: Center(
                                                            child: isLoading == true ? Shimmer.fromColors(
                                                              baseColor:
                                                              Colors.grey,
                                                              highlightColor:
                                                              Colors.white,
                        ...
                        Expanded(
                            ...
                            child: (listOfSortedPlaces.length != 0)
                                      ...
                                      GridView.builder(
                                          ...
                                          gridDelegate:
                                              SliverGridDelegateWithFixedCrossAxisCount(
                                                  childAspectRatio: .7,
                                                   crossAxisCount:  (ScreenWidth>1400) ? 4 : (ScreenWidth>1050) ? 3 :(ScreenWidth>695) ? 2: 1,
                                                  crossAxisSpacing: 16,
                                                  mainAxisSpacing: 15),
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          Expanded(
                                                              flex: 7,
                                                              child: InkWell(
                                                                borderRadius: BorderRadius.circular(25),hoverColor: Colors.transparent,
                                                                onTap: () {
                                                                  listOfSortedPlaces[
                                                                          index]
                                                                      .carouselController
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Text(
                                                                                '₹ ' + listOfSortedPlaces[index].amount.toString(),
                                ...
                                : Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        'No place is currently Available Sorry :)',
                                        style: TextStyle(
                                            fontSize: 20,
                                            fontFamily: 'Axiforma',
